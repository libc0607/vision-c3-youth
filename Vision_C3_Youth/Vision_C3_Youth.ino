//#define PCB_VERSION_ST7789
#define PCB_VERSION_GC9A01
#define VISION_BLE_EN
 ...
 *   arduino-esp32 
 *     Note: if upload failed in 2.0.3, try 2.0.2 or wait for 2.1.0 release
 *   Arduino_GFX @1.2.3
 *   JPEGDEC @1.2.6
 * c. Select "ESP32C3 Dev Module", 921600, CDC enabled, 160MHz, 80MHz, QIO, 4MB, 
 *    (BLE enabled)? (2MB APP/2MB FATFS): (1MB APP/3MB FATFS),
 *    then "Upload"
...
#endif
#ifdef PCB_VERSION_GC9A01
#define PIN_BOOT_KEY    10
#define PIN_LDO_LATCH   6
#define PIN_SPI_MISO    -1
#define PIN_BAT_ADC     0   // in arduino-esp32@2.0.3 the analogRedaMillivolts() returns bad result and idk why
#define PIN_LCD_CS      3   
...
Arduino_DataBus *bus = new Arduino_ESP32SPI(PIN_LCD_DC, PIN_LCD_CS, PIN_SPI_CLK, PIN_SPI_MOSI, PIN_SPI_MISO);
Arduino_GC9A01  *gfx = new Arduino_GC9A01(bus, PIN_LCD_RST, 2, true); 
#endif
